...
<body>
  ...
  <div class="registro-container">
    ...
    <div class="form-container mt-5">
      ...
      <div class="col-md-12">
        <!-- Título -->
        <div class="title text-center mb-4">Comienza tu historia en EasyBuy</div>
        <div class="content">
          ...
          <form id="formReg">
            <div class="user-details row g-3">
              ...
              <!-- Apellido -->
              <div class="col-md-6 input-box">
                <span class="details">NIT de tienda</span>
                <input type="text" class="form-control" placeholder="Ingresa tu NIT." required>
              </div>
              <!-- Correo electrónico -->
              <div class="col-md-6 input-box">
              ...
              <div class="col-md-6 input-box">
                ...
                <input type="number" class="form-control" placeholder="Ingresa tu teléfono." required>
              </div>
              <!-- Contraseña -->
              <div class="col-md-6 input-box">
  ...
  <?php
  include('footer.php');
  include('Js/registro_tendero.js');
  ?>
</body>
